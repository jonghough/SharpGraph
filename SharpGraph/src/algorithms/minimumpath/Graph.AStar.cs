...
namespace SharpGraph
{
    ...
    public partial class Graph
    {
        ...
        {
            return FindMinPath(new List<Edge>(), nodeS, nodeF, heuristic);
        }

        public List<Node> FindMinPath(List<Edge> forbiddenEdges, Node nodeS, Node nodeF, IAStarHeuristic heuristic)
        {
            ...
            openSet.Add(nodeS);
            openPQ.Add(nodeS);
            List<Edge> allowedEdges = new List<Edge>(GetEdges());
            ...
            while (openPQ.Count > 0)
            {
                ...
                List<Edge> incident = GetIncidentEdges(current, match);
    ...
    internal class NodeComparer : IComparer<Node>
    {
        ...
        {
            if (func.GetHeuristic(src, o1) < func.GetHeuristic(src, o2)) return 1;
            else if (func.GetHeuristic(src, o1) > func.GetHeuristic(src, o2)) return -1;
            else return 0;
        }
    }
}